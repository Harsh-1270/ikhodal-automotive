        ...
        <nav className="admin-navbar">
                    ...
                    <div className="admin-profile-wrapper" ref={dropdownRef}>
                        ...
                        {showLogoutDropdown && (
                            <div className="admin-logout-dropdown">
                                <button className="admin-logout-dropdown-btn" onClick={handleLogout}>
                                    <span>
                                        <Icons.Logout />
                                    </span>
                                    <span>Logout</span>
            ...
            {mobileMenuOpen && (
                <div className="admin-mobile-menu active">
                    ...
                    <div className="admin-mobile-user-section" style={{ borderTop: '2px solid rgba(30, 58, 138, 0.1)', borderBottom: 'none', marginTop: '0.5rem' }}>
