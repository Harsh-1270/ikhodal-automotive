      ...
      <div className="admin-users-main">
        ...
        <div className="adm-users-grid">
          {loading ? (
            ...
            <div className="adm-empty-state">
              <div className="adm-empty-icon">
                <Icons.PauseCircle color="#ef4444" />
              </div>
              <h3>Error loading users</h3>
              <p>{error}</p>
              <button className="adm-clear-filters-btn" onClick={fetchUsers}>
                Retry
              </button>
            </div>
                ...
                <div key={user.id} className="adm-user-card">
                  ...
                  <div className="adm-user-card-header">
                    ...
                    <div className={`adm-user-status-badge ${status}`}>
                      {status === "active" ? (
                        <Icons.CircleDot color="#10b981" />
                      ) : (
                        <Icons.CircleDot color="#ef4444" />
                      )}
                  ...
                  <div className="adm-user-card-body">
                    ...
                    <div className="adm-user-card-details">
                      <div className="adm-detail-item">
                        <span className="adm-detail-icon">
                          <Icons.Mail />
                        </span>
                      ...
                      <div className="adm-detail-item">
                        ...
                        <span className="adm-detail-text">
                          {user.phone || "N/A"}
                        </span>
                      </div>
                      <div className="adm-detail-item">
