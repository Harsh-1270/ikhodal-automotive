  ...
  const Icons = {
    BarChart: ({ className = "" }) => (
      ...
      >
        ...
        <path
          d="M3 3v18h18M9 17V10m4 7V7m4 10v-4"
          stroke="url(#adBarChartGrad)"
          strokeWidth="2"
          fill="none"
          strokeLinecap="round"
        />
    ...
    CheckCircle: ({ className = "" }) => (
      <svg
        className={className}
        viewBox="0 0 24 24"
        fill="url(#adCheckCircleGrad)"
      >
        <defs>
          <linearGradient
            id="adCheckCircleGrad"
            x1="0%"
            y1="0%"
            x2="100%"
            y2="100%"
        ...
        try {
          ...
          if (response.success) {
            ...
            showToast(
              "success",
              "Booking Completed",
              `Booking ${booking.displayId} has been marked as completed.`,
            );
          } else {
            showToast(
              "error",
    ...
    <div className="admin-dashboard-container">
      ...
      <div className="adm-toast-container">
        {toasts.map((toast) => (
          <div
            key={toast.id}
            className={`adm-toast ${toast.type} ${toast.removing ? "removing" : ""}`}
          >
        ...
        >
          ...
          >
            ...
            <div className="adm-confirm-actions">
              ...
              <button
                className={`adm-confirm-btn confirm-${confirmModal.type}`}
        ...
        <div className="adm-bookings-list">
          {loading ? (
            ...
            <div className="adm-empty-state">
              ...
              <p>
                There are no {activeFilter !== "all" ? activeFilter : ""}{" "}
              ...
              <div key={booking.id} className="adm-booking-card">
                  ...
                  <div className="adm-booking-id-section">
                    ...
                    <span className={`adm-status-badge ${booking.status}`}>
                      ...
                      {booking.status === "completed" && (
                        <Icons.CheckCircle className="adm-status-icon" />
                      )}
                ...
                <div className="adm-customer-info">
                  ...
                  <div className="adm-customer-details">
                    ...
                    <div className="adm-customer-contact">
                      <span>
                        <Icons.Mail className="adm-contact-icon" />{" "}
                        {booking.userEmail}
                      </span>
                    </div>
                  </div>
                ...
                <div className="adm-booking-footer">
                  <div className="adm-address-info">
                    <span className="adm-address-icon">
                      <Icons.MapPin />
                    </span>
