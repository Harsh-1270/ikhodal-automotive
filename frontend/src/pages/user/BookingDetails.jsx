...
const BookingDetails = () => {
  ...
  const Icons = {
    ...
    FileSearch: ({ className = "", stroke = "currentColor" }) => (
      <svg
        className={className}
        viewBox="0 0 24 24"
        fill="none"
    ...
    Factory: ({ className = "" }) => (
      <svg
        ...
        viewBox="0 0 24 24"
        fill="none"
        stroke="url(#dashPurpleRocketGradient)"
        strokeWidth="2"
      >
      ...
      try {
        ...
        if (response.success && response.data) {
          ...
          setBooking({
            ...
            servicesIncluded: b.services
              ? b.services.map((s) => s.serviceName)
              : [],
          ...
          setError(
            response.message ||
              "We couldn't load this booking. It may no longer exist or you may not have access to it.",
          );
        }
      } catch (error) {
        console.error("Error fetching booking:", error);
        setError(
          "Something went wrong while loading your booking. Please refresh the page or try again later.",
        );
      } finally {
        setLoading(false);
      }
        ...
        <div className="bd-error-card">
          ...
          <div className="bd-error-hints">
            <div className="bd-hint">
              <span className="bdhint-icon bdhint-blue">
                <Icons.Calendar />
              </span>
            ...
            <div className="bd-hint">
              <span className="bdhint-icon bdhint-orange">
                <Icons.Clock />
              </span>
            ...
            <div className="bdhint-divider"></div>
            <div className="bd-hint">
              <span className="bdhint-icon bdhint-green">
                <Icons.Phone />
              </span>
          ...
          <div className="header-left">
            <h1 className="details-title">
              <span className="title-icon">
                <Icons.FileSearch stroke="#1e3a8a" />
              </span>
              Booking Details
            </h1>
              ...
              <div className="card-body">
                <div className="service-showcase">
                  ...
                  <div className="service-info-text">
                    <h3 className="service-name-large">
                      {booking.serviceName}
                    </h3>
                ...
                <div className="info-rows">
                  <div className="info-row">
                    <span className="info-label">
                      <Icons.Calendar className="inline-icon" /> Date
                    </span>
                  ...
                  <div className="info-row">
                    <span className="info-label">
                      <Icons.Clock className="inline-icon" /> Time Slot
                    </span>
                ...
                <div className="services-included">
                  <h4 className="included-title">
                    <Icons.Sparkles className="inline-icon" /> Services Included
                  </h4>
            ...
            <div className="detail-card">
              ...
              <div className="card-body">
                <div className="info-rows">
                  <div className="info-row">
                    <span className="info-label">
                      <Icons.Hash className="inline-icon" /> Registration
                    </span>
            ...
            <div className="detail-card">
              ...
              <div className="card-body">
                <div className="info-rows">
                  ...
                  <div className="info-row">
                    <span className="info-label">
                      <Icons.MapPin className="inline-icon" /> Address
                    </span>
                    <span className="info-value">
                ...
                <div className="center-info">
                  ...
                  <div className="center-contact">
                    <span className="contact-icon">
                      <Icons.Phone className="inline-icon" />
                    </span>
                    <span className="contact-text">
                      {booking.serviceCenterPhone}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="card-body">
                <div className="payment-total">
                  ...
                  <span className="total-value">
                    AUD {booking.totalPrice.toLocaleString()}
                  </span>
                </div>
                <span
                  style={{
