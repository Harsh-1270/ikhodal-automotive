      ...
      >
        ...
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            Experience excellence in car servicing.
            <br />
        ...
        <div className="section-container">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              Excellence in automotive care with cutting-edge technology and
              expert service
            </p>
          </div>
          ...
          <div className="about-grid">
            ...
            <div className="about-card">
              ...
              <p>
                Premium parts and meticulous attention to detail in every
                service we provide
              </p>
            </div>
            ...
            <div className="about-card">
              ...
              <h3>Easy Booking</h3>
              <p>
                Seamless online booking system to schedule your service at your
                convenience
              </p>
            </div>
          </div>
            ...
            {[
              {
                ...
                desc: "Oil changes, filter replacements, and routine checkups",
                featured: false,
              },
              {
                icon: <Icons.Magnifier />,
                title: "Complete Inspection",
                desc: "Thorough diagnostic and inspection services",
                featured: true,
              },
              {
                icon: <Icons.Gear />,
              ...
              },
              {
                icon: <Icons.Paint />,
                title: "Body Work",
                desc: "Professional painting and body repair services",
                featured: false,
              },
              {
                icon: <Icons.CarFront />,
      ...
      >
        <div className="section-container">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              Get your car serviced in three easy steps
            </p>
          </div>
          ...
          <div className="steps-container">
            <div className="step-card">
              ...
              <p>
                Choose your service and select a convenient date and time slot
              </p>
            </div>
            ...
            <div className="step-card">
              ...
              <p>
                Our expert technicians provide quality service at our facility
              </p>
            </div>
