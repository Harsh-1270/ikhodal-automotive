...
const Payments = () => {
  ...
  const Icons = {
    ...
    Wallet: ({ className = "", stroke = "currentColor" }) => (
      <svg
        className={className}
        viewBox="0 0 24 24"
        fill="none"
    ...
    DollarSign: ({ className = "", color = "#16a34a" }) => (
      <svg
        className={className}
        viewBox="0 0 24 24"
        fill="none"
  ...
  useEffect(() => {
        ...
        if (entry.isIntersecting && entry.intersectionRatio >= 0.05) {
          ...
          setTimeout(() => {
            setVisibleTransactions(
              (prev) => new Set([...prev, String(transactionId)]),
            );
          }, 100);
        }
      });
    ...
    const refsSnapshot = transactionRefs.current;
      ...
      <div className="payments-main">
        ...
        <div className="stats-row">
          ...
          <div className="stat-box">
            ...
            <div className="stat-details">
              <div className="stat-value">
                ${stats.lastTransaction.amount.toLocaleString()}
              </div>
          ...
          {loading ? (
            ...
            <div className="empty-state">
              <div className="empty-state-visual">
                ...
                <div className="empty-state-icon">
                  <Icons.Wallet stroke="url(#dashBlueGradient)" />
                </div>
              </div>
              ...
              <div className="empty-state-perks">
                ...
                <div className="eperk-divider"></div>
                <div className="empty-perk">
                  <span className="eperk-icon eperk-purple">
                    <Icons.Sparkles />
                  </span>
            ...
            sortedTransactions.map((transaction, index) => (
              <div
                ...
                style={{
                  animationDelay: visibleTransactions.has(
              ...
              >
                <div className="transaction-left">
                  <div className="transaction-icon-wrapper">
                    <div className="transaction-icon">
                      {getIconComponent(transaction.serviceIcon)}
                    </div>
                  </div>
                  <div className="transaction-details">
                    <h3 className="transaction-service">
                ...
                <div className="transaction-right">
                  ...
                  <button
                    ...
                    onClick={() =>
                      navigate(`/booking-details/${transaction.bookingId}`, {
                        state: { from: "/payment" },
                      })
                    }
                  >
