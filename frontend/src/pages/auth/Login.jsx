  ...
  const Icons = {
    Monitor: ({ className = "" }) => (
      <svg
        ...
        viewBox="0 0 24 24"
        fill="none"
        stroke="url(#loginMonitorGradient)"
        strokeWidth="2"
        strokeLinecap="round"
    ...
    Lightning: ({ className = "" }) => (
      <svg
        className={className}
        viewBox="0 0 24 24"
        fill="url(#loginLightningGradient)"
      >
        <defs>
          <linearGradient
            id="loginLightningGradient"
            x1="0%"
            y1="0%"
            x2="100%"
            y2="100%"
    ...
    AlertTriangle: ({ className = "" }) => (
      <svg
        className={className}
        viewBox="0 0 24 24"
        fill="url(#loginAlertGradient)"
      >
        <defs>
          <linearGradient
            id="loginAlertGradient"
            x1="0%"
            y1="0%"
            x2="100%"
            y2="100%"
