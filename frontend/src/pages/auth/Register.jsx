  ...
  const Icons = {
    ...
    Lightning: ({ className = "" }) => (
      <svg
        className={className}
        viewBox="0 0 24 24"
        fill="url(#regLightningGradient)"
      >
        <defs>
          <linearGradient
            id="regLightningGradient"
            x1="0%"
            y1="0%"
            x2="100%"
            y2="100%"
    ...
    Diamond: ({ className = "" }) => (
      <svg
        className={className}
        viewBox="0 0 24 24"
        fill="url(#regDiamondGradient)"
      >
        <defs>
          <linearGradient
            id="regDiamondGradient"
            x1="0%"
            y1="0%"
            x2="100%"
            y2="100%"
    ...
    Rocket: ({ className = "" }) => (
      <svg
        className={className}
        viewBox="0 0 24 24"
        fill="url(#regRocketGradient)"
      >
        <defs>
          <linearGradient
            id="regRocketGradient"
            x1="0%"
            y1="0%"
            x2="100%"
            y2="100%"
