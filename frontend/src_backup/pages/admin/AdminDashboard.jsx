...
const AdminDashboard = () => {
    ...
    const Icons = {
        ...
        Car: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="url(#adCarGrad)" stroke="url(#adCarGrad)" strokeWidth="1">
                <defs>
                    <linearGradient id="adCarGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stopColor="#6366f1" />
                        <stop offset="100%" stopColor="#8b5cf6" />
                    </linearGradient>
                </defs>
                <path d="M5 17h2m10 0h2M5 17H3v-4l2-5h10l2 5h2v4h-2M5 17a2 2 0 1 0 4 0m6 0a2 2 0 1 0 4 0" fill="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        )
    };
