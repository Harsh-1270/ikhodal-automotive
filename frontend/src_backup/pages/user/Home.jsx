...
const Home = () => {
    ...
    const Icons = {
        Car: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="url(#carGradient)">
                <defs>
        ...
        Sparkles: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="url(#sparklesGradient)">
                <defs>
        ...
        Target: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="none" stroke="url(#targetGradient)" strokeWidth="2">
                <defs>
        ...
        Lightning: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="url(#lightningGradient)">
                <defs>
        ...
        Trophy: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="url(#trophyGradient)">
                <defs>
        ...
        Users: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="none" stroke="url(#usersGradient)" strokeWidth="2">
                <defs>
        ...
        Wrench: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="url(#wrenchGradient)">
                <defs>
        ...
        Phone: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="none" stroke="url(#phoneGradient)" strokeWidth="2">
                <defs>
        ...
        Tool: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="url(#toolGradient)">
                <defs>
        ...
        Magnifier: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="none" stroke="url(#magnifierGradient)" strokeWidth="2">
                <defs>
        ...
        Gear: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="url(#gearGradient)">
                <defs>
        ...
        Paint: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="url(#paintGradient)">
                <defs>
        ...
        CarFront: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="url(#carFrontGradient)">
                <defs>
        ...
        Battery: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="url(#batteryGradient)">
                <defs>
        ...
        Calendar: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="none" stroke="url(#calendarGradient)" strokeWidth="2">
                <defs>
        ...
        Check: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="none" stroke="url(#checkGradient)" strokeWidth="3">
                <defs>
        ...
        MapPin: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="none" stroke="url(#mapPinGradient)" strokeWidth="2">
                <defs>
        ...
        Mail: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="none" stroke="url(#mailGradient)" strokeWidth="2">
                <defs>
        ...
        Clock: ({ className = "" }) => (
            <svg className={className} viewBox="0 0 24 24" fill="none" stroke="url(#clockGradient)" strokeWidth="2">
                <defs>
